...
pub mod async_std {
    ...
    #[cfg_attr(docsrs, doc(cfg(all(feature = "async-std", feature = "async-native-tls-std"))))]
    ...
    #[cfg(all(feature = "async-std", feature = "async-rustls"))]
    #[cfg_attr(docsrs, doc(cfg(all(feature = "async-std", feature = "async-rustls"))))]
...
pub mod tokio {
    pub use super::tokio_ftp::AsyncNoTlsStream;
    pub use super::tokio_ftp::ImplAsyncFtpStream;
    pub type AsyncFtpStream = ImplAsyncFtpStream<AsyncNoTlsStream>;

    #[cfg(all(feature = "tokio", feature = "async-native-tls-tokio"))]
    #[cfg_attr(docsrs, doc(cfg(all(feature = "tokio", feature = "async-native-tls-tokio"))))]
